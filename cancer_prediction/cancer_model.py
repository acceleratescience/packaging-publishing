...
class CancerModel:
    ...
    def get_feature_importance(self) -> np.ndarray:
        ...
        Returns:
            np.ndarray: Principal axes in feature space, representing the directions of maximum variance in the data.
        """
        return self.pca.components_

    def get_feature_variance(self) -> np.ndarray:
    ...
    def get_feature_importance_df(self, X: np.ndarray | pd.DataFrame) -> pd.DataFrame:
        """_summary_
    ...
    def get_feature_importance_df_sorted_by_variance_and_variance(
